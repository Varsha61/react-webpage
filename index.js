...
const uri = "mongodb+srv://varshatest@123>@cluster0.cjtrvno.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    const cloth=client.db("demo").collection("snacks");
